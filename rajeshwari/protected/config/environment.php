...
define('BASEURL', 'http://cesocietyyadgir.com/rajeshwari');

//Database connections
define('DB_CONNECTION','mysql:host=localhost;port=3306;dbname=rajeshwari');
define('DB_USER','rajeshwari');
define('DB_PWD','Walter#07');
define('FEES_ENABLED', false);
define('EMAIL_ALERT_ADDRESS', 'secretary@cesocietyyadgir.com');
